...
package-relative imports, so `python tools/listing.py symbols
build/game.symbols.json` works from the project root. Re-forked 2026-09-14
for Baron's --symbols dump.
