...
| The frame boundary symbol to break on (the redraw `JSR`, or the top of the main loop) | the build's symbol dump (`tools/listing.py symbols build/<NAME>.symbols.json`) |
