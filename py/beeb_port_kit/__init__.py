...
package as well so the tests can import it.
    ...
    zx0      Einar Saukas's ZX0 compressor and decompressor, in Python
    dfs      DFS .ssd images: catalogue, layout, padding, the ZX0 stream checks
