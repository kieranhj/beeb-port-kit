...
beeb-port-kit: this is what NEW ports compress with. zx0.py is kept beside it
because the two shipping ports (paradroid-beeb, edge-beeb) are ZX0 discs and
their tools must stay byte-identical to what shipped; nothing in the kit reads
both, so a project picks one and forks that file.
